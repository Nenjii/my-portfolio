        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-xs font-mono text-[var(--muted)] border border-[var(--border)] px-4 py-2 hover:bg-[var(--foreground)] hover:text-[var(--background)] transition-all">LINKEDIN</a>
              <a href="#" className="text-xs font-mono text-[var(--muted)] border border-[var(--border)] px-4 py-2 hover:bg-[var(--foreground)] hover:text-[var(--background)] transition-all">GITHUB</a>
              <a href="#" className="text-xs font-mono text-[var(--muted)] border border-[var(--border)] px-4 py-2 hover:bg-[var(--foreground)] hover:text-[var(--background)] transition-all">TWITTER</a>
            </div>
          </div>
